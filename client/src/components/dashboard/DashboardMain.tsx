        ...
        <div className="p-6 md:p-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="flex flex-col gap-1 bg-surface border border-border rounded-2xl p-6">
                    <span className="text-xs font-medium uppercase tracking-wide text-muted">Total Income</span>
                    <span className="text-2xl font-semibold text-green">$0.00</span>
                </div>
                <div className="flex flex-col gap-1 bg-surface border border-border rounded-2xl p-6">
                    <span className="text-xs font-medium uppercase tracking-wide text-muted">Total Expenses</span>
                    <span className="text-2xl font-semibold text-red">$0.00</span>
                </div>
                <div className="flex flex-col gap-1 bg-surface border border-border rounded-2xl p-6">
                    <span className="text-xs font-medium uppercase tracking-wide text-muted">Balance</span>
                    <span className="text-2xl font-semibold text-brown">$0.00</span>
                </div>
            </div>
